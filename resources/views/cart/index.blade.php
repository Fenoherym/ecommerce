                        ...
                        @foreach (Cart::content() as $product)
                             <tr>
                                ...
                                <div class="p-2">
                                    ...
                                    <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">{{ $product->model->title }}s</a>
                                ...
                                <td class="border-0 align-middle">
                                    ...
                                    <form action="{{ route('cart.destroy', $product->rowId) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-dark"><i class="fa fa-trash"></i></button></td>
                                    </form>
